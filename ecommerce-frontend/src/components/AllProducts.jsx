...
function AllProduct(){
    ...
    const loadDataFromServer=(page=0,pagesize=8)=>{
        axios.get("http://localhost:4000/api/products/paginated?page="+page+"&pagesize="+pagesize)
            .then(resp=>{
    ...
    useEffect(()=>{
        ...
        if(pcat.cat!==undefined){
            axios.get("http://localhost:4000/api/products?cat="+pcat.cat)
            .then(resp=>{
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            <div className="d-flex">
                                <img src={"http://localhost:4000/"+item.photo} style={{width:"200px"}}/>
                                <div className="ml-3">
