...
function NavBar(){
    ...
    return (
        <Fragment>
            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-dark position-sticky" style={{top:0,zIndex:"1000"}}>
                {/* <Link className="navbar-brand" to="#">E-Shop</Link> */}
                <img src={'shop.jpg'} style={{width:"175px"}} className="float-left"/>
                ...
                <div className="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <li className="nav-item active">
                        <Link className="nav-link" to="/" style={{ color: 'white',fontSize:'22px'}}>Home</Link>
                    </li>
                    <li className="nav-item active">
